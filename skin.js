(() => {
  ...
  steamKnight: {
    ...
    canvas: {
      ...
      period: 2100,
      effects: {
        // 背景齒輪：3 個超大與 5 個大齒輪，30 秒一圈，固定不重疊
        gears: {
          rotationMs: 30000,
          layout: [
            // 三個超大齒輪
            { x: 0.136, y: 0.857, r: 0.214, teeth: 12 },
            { x: 0.5,   y: 0.857, r: 0.214, teeth: 12 },
            { x: 0.864, y: 0.857, r: 0.214, teeth: 12 },
            // 五個普通大齒輪（部分位於畫布外以增廣視覺）
            { x: -0.073, y: 1.086, r: 0.143, teeth: 10 },
            { x: 0.318,  y: 1.086, r: 0.143, teeth: 10 },
            { x: 0.682,  y: 1.086, r: 0.143, teeth: 10 },
            { x: 1.073,  y: 1.086, r: 0.143, teeth: 10 },
            { x: 0.5,    y: 1.286, r: 0.143, teeth: 10 }
          ]
        },
        sparks: { count: 40 }
      },
