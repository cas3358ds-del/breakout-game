    ...
    canvas: {
      ...
      effects: {
        ...
        gears: {
          ...
          layout: [
            // 依序排列的齒輪鏈（部分超出畫布邊界）
            { x: -0.05,  y: 0.85, r: 0.18, teeth: 10 },
            { x: 0.209, y: 0.85, r: 0.28, teeth: 12 },
            { x: 0.468, y: 0.85, r: 0.18, teeth: 10 },
            { x: 0.727, y: 0.85, r: 0.28, teeth: 12 },
            { x: 0.986, y: 0.85, r: 0.18, teeth: 10 },
            { x: 1.245, y: 0.85, r: 0.28, teeth: 12 },
            { x: 1.504, y: 0.85, r: 0.18, teeth: 10 },
            { x: 1.707, y: 0.85, r: 0.18, teeth: 10 }
          ]
        },
        sparks: { count: 40 }
      },
